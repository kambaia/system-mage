...
export const CustomerUpdateForm = ({initialValues}:IProps) => {
  ...
  useEffect(() => {
	...
	if (initialValues) {
		let arr: Array<string> = initialValues?.fullName.split(" ");
		let first = [...arr].shift() as string;
		let last = [...arr].pop() as string;
        ...
        <div className="flex flex-wrap my-5 sm:my-8">
          ...
          <Card className="w-full sm:w-8/12 md:w-2/3">
            ...
            <div className="mb-4 text-right">
              <CardButton>
                {isLoading ? 'Enviando...' : <Button>Actualizar a conta</Button>}
              </CardButton>
            </div>
          </Card>
        </div>
